<template>
  <tab-bar>
      <tab-bar-item path="/home" activeColor="#d63823">
        <template #item-icon><img src="../assets/img/home.svg" alt=""></template>
        <template #item-icon-active><img src="../assets/img/home-active.svg" alt=""></template>
